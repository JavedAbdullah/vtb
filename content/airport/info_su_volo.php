...
$connection = mysqli_connect("localhost","root","","vtb",3326);
    ...
    $result = mysqli_query($connection,$query);
        ...
        echo" <th>&#128186; posto</th>";
        echo"<th>&#128101; numero adulti</th>";
        echo"<th>&#128101; numero bambini </th>";
        echo"<th>&#10003; check-in</th>";
        echo"<th>&#128176; costo</th>";
        echo"<th>&#128204; classe</th>"; 
    ...
    if(mysqli_num_rows($result)!=0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            if($row[4]!=null){echo" <th><h3>effettuato</h3></th>";} else{echo" <th><h3>non effettuato</h3></th>";}
            //echo" <th><h3>$row[4]</h3></th>";
            echo" <th><h3>$row[5]€</h3></th>";
            echo" <th><h3>$row[6]</h3></th>";
