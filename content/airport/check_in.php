...
background: #394D61;
    ...
    <body>
      ...
      <!-- <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        ...
        <form class="form-style-4" action="successo.php" method="post">
<label for="field1">
<div class="logo">
...
<span>scegliere ID prenotazione per il chek-in</span>

<select name="biglietto" id="biglietto">
<?php
$id_cliente =  $_SESSION["id_cliente"];
$connection = mysqli_connect("localhost","root","","vtb",3326);
$query = "SELECT prenotazioni.cod_prenotazione
from prenotazioni,clienti
WHERE prenotazioni.id_cliente = clienti.id_cliente and clienti.id_cliente=$id_cliente";
...
<label>
<span> </span><input type="submit" value="effettua check-in" class="btn btn-success btn-lg"/>
</label>
</form>
