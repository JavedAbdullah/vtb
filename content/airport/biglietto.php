...
background: #394D61;
    ...
    <body>
      ...
      <!-- <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        ...
        <form class="form-style-4" action="genera_bigliettto.php" method="post">
<label for="field1">
<div class="logo">
...
<span>scegliere ID prenotazione</span>
...
<label>
<span> </span><input type="submit" value="genera biglietto" class="btn btn-success btn-lg"/>
</label>
</form>
